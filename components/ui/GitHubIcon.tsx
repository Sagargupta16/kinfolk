/**
 * GitHub mark. Inlined rather than pulled from lucide, whose `Github` icon is a
 * simplified outline that reads as generic next to the real logo on a sign-in
 * button.
 */
export function GitHubIcon({ className }: { className?: string }) {
	// Decorative: the button it sits in already says "Continue with GitHub".
	return (
		<svg viewBox="0 0 16 16" fill="currentColor" role="presentation" className={className}>
